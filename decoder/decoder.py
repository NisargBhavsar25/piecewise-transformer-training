...
from modules import Tokenizer, TextDataset, DecoderModel
import os
...
def main():
    ...
    model = DecoderModel(vocab_size, d_model, N, heads).to(device)
    ...
    plt.savefig('decoder/training_validation_loss.png')

    # Save the model
    torch.save(model.state_dict(), 'decoder/decoder_model.pth')
