...
from modules import Tokenizer, TextDataset, EmbeddingModel
import os
...
def main():
    ...
    model = EmbeddingModel(vocab_size, d_model).to(device)
    ...
    plt.savefig('embedding/training_validation_loss.png')

    # Save the model
    torch.save(model.state_dict(), 'embedding/embedding_model.pth')
